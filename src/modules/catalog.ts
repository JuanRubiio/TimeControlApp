export type ModuleKey='shift_planning'|'people_management'|'exports'|'informative_hour_balance';
...
export const PRODUCT_MODULES:readonly ProductModule[]=[
  ...
  {key:'people_management',name:'Gestión de personas',description:'Altas, asignación a centro y mantenimiento de la plantilla.',availability:'Disponible al instalarlo.',locked:false},
