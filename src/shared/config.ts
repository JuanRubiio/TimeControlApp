...
const schema = z.object({
  ...
  // El build de Next evalúa rutas sin secretos de runtime. El servicio de PIN
  // exige este valor al ejecutarse; no se aplica ningún valor por defecto.
  KIOSK_PIN_PEPPER: z.string().min(32).optional(),
