...
export default function Home(){
  return <main className="landing-shell">
    ...
    <section className="landing-hero" aria-labelledby="landing-title"><p className="eyebrow">Control horario para el piloto</p><h1 id="landing-title">Una jornada clara, trazable y centrada en las personas.</h1><p className="landing-lead">TimeControl ayuda a equipos y responsables a registrar la jornada con información comprensible, decisiones revisables y límites explícitos.</p><Link className="landing-cta" href="/login">Acceder a TimeControl</Link></section>
    ...
    <footer className="landing-footer">TimeControl · Piloto de control horario</footer>
  </main>;
}
