...
describe('S2 validaciones de datos mínimos', () => {
  ...
  it('exige una zona IANA de centro y un rango laboral no invertido', () => { expect(siteInput.safeParse({name:'Madrid',timeZone:'Europe/Madrid'}).success).toBe(true); expect(siteInput.safeParse({name:'Madrid',timeZone:'UTC'}).success).toBe(false); expect(employmentInput.safeParse({employeeId:'00000000-0000-4000-8000-000000000001',siteId:'00000000-0000-4000-8000-000000000002',effectiveFrom:'2026-09-10',effectiveTo:'2026-09-10'}).success).toBe(false); });
});
