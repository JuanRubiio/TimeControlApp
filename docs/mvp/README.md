...
| ADR-TC-016 | [34-decision-piloto-y-puerta-exportacion.md](34-decision-piloto-y-puerta-exportacion.md) | S | Propuesta para PO: recorrido sintético asistido y puerta verificable antes de cualquier exportación visible |
...
| HU-TC-040 | [40-tipologias-ausencia-configurables-versionadas.md](40-tipologias-ausencia-configurables-versionadas.md) | M | Refinamiento bloqueado: catálogo cerrado, configurable por versión e instantánea histórica; sin saldo, datos sensibles ni efectos de jornada |
