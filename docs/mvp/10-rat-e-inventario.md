...
| Jornada, cálculo y corrección | entrada/salida/pausas, fecha laboral, zona, método, regla/relación fijadas, timestamp de servidor; timestamp del dispositivo opcional; cálculo/versiones/incidencias; solicitud, motivo, decisión y efecto de corrección | registro diario de jornada y gestión de errores con evidencia; art. 34.9 ET y base RGPD que confirme el cliente | empleado, responsables autorizados, RLT/Inspección cuando proceda, exportación autorizada | **mínimo 4 años** desde el registro, con preservación de evidencia y correcciones vinculadas |
...
| Exportaciones | CSV/PDF de jornada, snapshot, manifiesto/hash, alcance, solicitante y descarga | atender acceso/obligaciones y entrega autorizada | solicitante legitimado | archivo disponible lógicamente hasta 30 días; eliminación física programada pendiente; manifiesto/evidencia conforme a retención de auditoría |
