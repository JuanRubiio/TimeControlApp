...
| Exportaciones | S9 limita el alcance a una persona o centro autorizado, genera CSV/PDF sin URL pública, comprueba hash antes de descargar y audita generación/descarga. S15 añade el recolector interno que elimina el artefacto vencido dentro del almacenamiento dedicado y conserva manifiesto/snapshot/auditoría. | Implementado localmente; faltan política/bloqueo aprobados y evidencia operativa/Docker antes de datos reales. |
